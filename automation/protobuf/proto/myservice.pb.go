...
const file_proto_myservice_proto_rawDesc = "" +
	"\n" +
	"\x15proto/myservice.proto\x12\tmyservice\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"#\n" +
	"\rHelloResponse\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name2J\n" +
	"\tMyService\x12=\n" +
	"\bSayHello\x12\x17.myservice.HelloRequest\x1a\x18.myservice.HelloResponseB\bZ\x06proto/b\x06proto3"

var (
	file_proto_myservice_proto_rawDescOnce sync.Once
	file_proto_myservice_proto_rawDescData []byte
)

func file_proto_myservice_proto_rawDescGZIP() []byte {
	file_proto_myservice_proto_rawDescOnce.Do(func() {
		file_proto_myservice_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_myservice_proto_rawDesc), len(file_proto_myservice_proto_rawDesc)))
	})
...
var file_proto_myservice_proto_goTypes = []any{
	(*HelloRequest)(nil),  // 0: myservice.HelloRequest
	(*HelloResponse)(nil), // 1: myservice.HelloResponse
}
var file_proto_myservice_proto_depIdxs = []int32{
	0, // 0: myservice.MyService.SayHello:input_type -> myservice.HelloRequest
	1, // 1: myservice.MyService.SayHello:output_type -> myservice.HelloResponse
...
func file_proto_myservice_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_myservice_proto_rawDesc), len(file_proto_myservice_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
